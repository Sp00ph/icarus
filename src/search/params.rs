...
tunable_params!(
    ...
    rfp_quad_margin         : i16 = 723     (384..=1536);
    movepick_see_threshold  : i32 = -12     (-100..=100);
    qs_see_threshold        : i32 = -1      (-100..=100);
    tactic_see_base         : i32 = 1       (0..=30);
    tactic_see_scale        : i32 = -62     (-120..=-30);
    quiet_see_base          : i32 = 1       (0..=30);
    quiet_see_scale         : i32 = -104    (-200..=-50);
    lmp_base                : u32 = 4231    (2048..=8192);
    lmp_scale               : u32 = 1063    (512..=2048);
    fp_base                 : i16 = 100     (50..=200);
    fp_scale                : i32 = 76      (40..=160);
    iid_depth_scale         : i32 = 827     (1536..=6144);
    iid_depth_offset        : i32 = 1816    (768..=3584);
    qsfp_margin             : i16 = 156     (80..=300);
    hist_prune_scale        : i32 = 1954    (1000..=4000);
    se_tt_depth_offset      : i32 = 3277    (1024..=6144);
    se_beta_scale           : i32 = 254     (192..=384);
    se_dext_margin          : i16 = 20      (10..=40);
    se_single_ext           : i32 = 1027    (512..=2048);
    se_double_ext           : i32 = 989     (512..=2048);
    se_triple_negext        : i32 = -3018   (-4096..=-1536);
    se_double_negext        : i32 = -2056   (-3072..=-1024);
    se_single_negext        : i32 = -1041   (-1536..=-512);
    quiet_hist_lmr_div      : i32 = 7976    (4096..=16384);
    probcut_margin          : i16 = 380     (200..=750);
    probcut_depth_offset    : i32 = 2138    (1024..=4096);
    lmr_base                : i32 = 511     (256..=1024);
    lmr_quiet_div           : i32 = 1627    (768..=3072);
    lmr_tactic_div          : i32 = 3533    (1792..=7168);
    lmr_nonpv               : i32 = 1069    (512..=2048);
    lmr_ttpv                : i32 = 953     (512..=2048);
    lmr_check               : i32 = 1040    (512..=2048);
    lmr_cutnode             : i32 = 1025    (512..=2048);
    lmr_exact               : i32 = 1097    (512..=2048);
    hindsight_ext_min_red   : i32 = 2927    (1536..=6144);
    hindsight_ext_ext       : i32 = 1047    (512..=2048);
    corr_bonus_scale        : i32 = 131     (64..=256);
    corr_bonus_div          : i32 = 1057    (512..=2048);
    corr_pawn_factor        : i32 = 63      (32..=128);
    corr_minor_factor       : i32 = 62      (32..=128);
    corr_major_factor       : i32 = 61      (32..=128);
    corr_white_factor       : i32 = 63      (32..=128);
    corr_black_factor       : i32 = 69      (32..=128);
    corr_cont1_factor       : i32 = 60      (32..=128);
    corr_cont2_factor       : i32 = 70      (32..=128);
    main_bonus_base         : i32 = 125     (64..=256);
    main_bonus_scale        : i32 = 132     (64..=256);
    main_bonus_max          : i32 = 2094    (1024..=4096);
    main_malus_base         : i32 = 129     (64..=256);
    main_malus_scale        : i32 = 131     (64..=256);
    main_malus_max          : i32 = 2104    (1024..=4096);
    tactic_bonus_base       : i32 = 124     (64..=256);
    tactic_bonus_scale      : i32 = 139     (64..=256);
    tactic_bonus_max        : i32 = 2042    (1024..=4096);
    tactic_malus_base       : i32 = 124     (64..=256);
    tactic_malus_scale      : i32 = 134     (64..=256);
    tactic_malus_max        : i32 = 2028    (1024..=4096);
    cont1_bonus_base        : i32 = 125     (64..=256);
    cont1_bonus_scale       : i32 = 139     (64..=256);
    cont1_bonus_max         : i32 = 2131    (1024..=4096);
    cont1_malus_base        : i32 = 129     (64..=256);
    cont1_malus_scale       : i32 = 129     (64..=256);
    cont1_malus_max         : i32 = 2056    (1024..=4096);
    cont2_bonus_base        : i32 = 123     (64..=256);
    cont2_bonus_scale       : i32 = 134     (64..=256);
    cont2_bonus_max         : i32 = 1977    (1024..=4096);
    cont2_malus_base        : i32 = 127     (64..=256);
    cont2_malus_scale       : i32 = 125     (64..=256);
    cont2_malus_max         : i32 = 2046    (1024..=4096);
    cont4_bonus_base        : i32 = 133     (64..=256);
    cont4_bonus_scale       : i32 = 116     (64..=256);
    cont4_bonus_max         : i32 = 2107    (1024..=4096);
    cont4_malus_base        : i32 = 117     (64..=256);
    cont4_malus_scale       : i32 = 130     (64..=256);
    cont4_malus_max         : i32 = 2066    (1024..=4096);
    asp_initial_window      : i16 = 22      (10..=100);
    asp_widen_factor        : i32 = 130     (64..=256);
    hard_time_factor       : u128 = 2008    (1024..=3072);
    soft_time_factor       : u128 = 69      (32..=256);
    node_tm_base            : u32 = 2513    (1280..=3840);
    node_tm_scale           : u32 = 1549    (768..=3072);
    move_stability_base     : u32 = 1848    (920..=2760);
    move_stability_scale    : u32 = 103     (50..=200);
    move_stability_min      : u32 = 923     (768..=1024);
    pawn_see_val            : i32 = 107     (50..=200);
    knight_see_val          : i32 = 295     (150..=600);
    bishop_see_val          : i32 = 302     (150..=600);
    rook_see_val            : i32 = 470     (250..=1000);
    queen_see_val           : i32 = 910     (450..=1800);
    mat_scaling_base        : i32 = 24018   (12000..=50000);
    pawn_mat_scale          : i32 = 96      (50..=200);
    knight_mat_scale        : i32 = 279     (150..=600);
    bishop_mat_scale        : i32 = 305     (150..=600);
    rook_mat_scale          : i32 = 492     (250..=1000);
    queen_mat_scale         : i32 = 962     (450..=1800);
);
