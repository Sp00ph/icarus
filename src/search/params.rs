...
tunable_params!(
    rfp_margin              : i16 = 45      (25..=100);
    rfp_quad_margin         : i16 = 638     (384..=1536);
    movepick_see_threshold  : i16 = -12       (-100..=100);
    qs_see_threshold        : i16 = -6       (-100..=100);
    tactic_see_base         : i16 = 2       (0..=30);
    tactic_see_scale        : i32 = -65     (-120..=-30);
    quiet_see_base          : i16 = 2       (0..=30);
    quiet_see_scale         : i32 = -116    (-200..=-50);
    lmp_base                : u32 = 4321    (2048..=8192);
    lmp_scale               : u32 = 1052    (512..=2048);
    fp_base                 : i16 = 106     (50..=200);
    fp_scale                : i32 = 73      (40..=160);
    hist_prune_scale        : i32 = 2477    (1000..=4000);
    se_tt_depth_offset      : i32 = 3187    (1024..=6144);
    se_beta_scale           : i32 = 268     (192..=384);
    se_dext_margin          : i16 = 19      (10..=40);
    se_single_ext           : i32 = 1294    (512..=2048);
    se_double_ext           : i32 = 1088    (512..=2048);
    se_triple_negext        : i32 = -3281   (-4096..=-1536);
    se_double_negext        : i32 = -2138   (-3072..=-1024);
    se_single_negext        : i32 = -1032   (-1536..=-512);
    quiet_hist_lmr_div      : i16 = 7907    (4096..=16384);
    lmr_base                : i32 = 583     (256..=1024);
    lmr_quiet_div           : i32 = 1828    (768..=3072);
    lmr_tactic_div          : i32 = 3751    (1792..=7168);
    lmr_nonpv               : i32 = 1279    (512..=2048);
    lmr_ttpv                : i32 = 1178    (512..=2048);
    lmr_check               : i32 = 1120    (512..=2048);
    lmr_cutnode             : i32 = 1091    (512..=2048);
    corr_bonus_scale        : i32 = 119     (64..=256);
    corr_bonus_div          : i32 = 1081    (512..=2048);
    corr_pawn_factor        : i32 = 51      (32..=128);
    corr_minor_factor       : i32 = 67      (32..=128);
    corr_major_factor       : i32 = 73      (32..=128);
    corr_white_factor       : i32 = 57      (32..=128);
    corr_black_factor       : i32 = 52      (32..=128);
    corr_cont1_factor       : i32 = 59      (32..=128);
    corr_cont2_factor       : i32 = 66      (32..=128);
    main_bonus_base         : i32 = 134     (64..=256);
    main_bonus_scale        : i32 = 130     (64..=256);
    main_bonus_max          : i32 = 2157    (1024..=4096);
    main_malus_base         : i32 = 120     (64..=256);
    main_malus_scale        : i32 = 127     (64..=256);
    main_malus_max          : i32 = 1338    (1024..=4096);
    tactic_bonus_base       : i32 = 138     (64..=256);
    tactic_bonus_scale      : i32 = 152     (64..=256);
    tactic_bonus_max        : i32 = 1620    (1024..=4096);
    tactic_malus_base       : i32 = 135     (64..=256);
    tactic_malus_scale      : i32 = 143     (64..=256);
    tactic_malus_max        : i32 = 2405    (1024..=4096);
    cont1_bonus_base        : i32 = 129     (64..=256);
    cont1_bonus_scale       : i32 = 158     (64..=256);
    cont1_bonus_max         : i32 = 1415    (1024..=4096);
    cont1_malus_base        : i32 = 124     (64..=256);
    cont1_malus_scale       : i32 = 151     (64..=256);
    cont1_malus_max         : i32 = 2411    (1024..=4096);
    cont2_bonus_base        : i32 = 126     (64..=256);
    cont2_bonus_scale       : i32 = 104     (64..=256);
    cont2_bonus_max         : i32 = 1905    (1024..=4096);
    cont2_malus_base        : i32 = 124     (64..=256);
    cont2_malus_scale       : i32 = 147     (64..=256);
    cont2_malus_max         : i32 = 2216    (1024..=4096);
    asp_initial_window      : i16 = 27      (10..=100);
    asp_widen_factor        : i32 = 144     (64..=256);
    hard_time_factor       : u128 = 1995    (1024..=3072);
    soft_time_factor       : u128 = 79      (32..=256);
    node_tm_base            : u32 = 2422    (1280..=3840);
    node_tm_scale           : u32 = 1757    (768..=3072);
    move_stability_base     : u32 = 2062    (920..=2760);
    move_stability_scale    : u32 = 119     (50..=200);
    move_stability_min      : u32 = 918     (768..=1024);
    pawn_see_val            : i16 = 93     (50..=200);
    knight_see_val          : i16 = 302     (150..=600);
    bishop_see_val          : i16 = 334     (150..=600);
    rook_see_val            : i16 = 552     (250..=1000);
    queen_see_val           : i16 = 980     (450..=1800);
);
