...
tunable_params!(
    rfp_margin              : i16 = 53      (25..=100);
    rfp_quad_margin         : i16 = 770     (384..=1536);
    movepick_see_threshold  : i32 = 13       (-100..=100);
    qs_see_threshold        : i32 = -8       (-100..=100);
    tactic_see_base         : i32 = 1       (0..=30);
    tactic_see_scale        : i32 = -68     (-120..=-30);
    quiet_see_base          : i32 = 1       (0..=30);
    quiet_see_scale         : i32 = -88    (-200..=-50);
    lmp_base                : u32 = 4688    (2048..=8192);
    lmp_scale               : u32 = 1167    (512..=2048);
    fp_base                 : i16 = 101     (50..=200);
    fp_scale                : i32 = 77      (40..=160);
    iid_depth_scale         : i32 = 807     (384..=1536);
    iid_depth_offset        : i32 = 1726    (768..=3584);
    qsfp_margin             : i16 = 159     (80..=300);
    hist_prune_scale        : i32 = 1962    (1000..=4000);
    se_tt_depth_offset      : i32 = 3050    (1024..=6144);
    se_beta_scale           : i32 = 252     (192..=384);
    se_dext_margin          : i16 = 21      (10..=40);
    se_single_ext           : i32 = 1107    (512..=2048);
    se_double_ext           : i32 = 973    (512..=2048);
    se_triple_negext        : i32 = -3176   (-4096..=-1536);
    se_double_negext        : i32 = -2033   (-3072..=-1024);
    se_single_negext        : i32 = -986   (-1536..=-512);
    quiet_hist_lmr_div      : i32 = 8713    (4096..=16384);
    probcut_margin          : i16 = 385     (200..=750);
    probcut_depth_offset    : i32 = 2025    (1024..=4096);
    lmr_base                : i32 = 469     (256..=1024);
    lmr_quiet_div           : i32 = 1848    (768..=3072);
    lmr_tactic_div          : i32 = 3544    (1792..=7168);
    lmr_nonpv               : i32 = 1103    (512..=2048);
    lmr_ttpv                : i32 = 961    (512..=2048);
    lmr_check               : i32 = 953    (512..=2048);
    lmr_cutnode             : i32 = 966    (512..=2048);
    lmr_exact               : i32 = 1103    (512..=2048);
    hindsight_ext_min_red   : i32 = 2701    (1536..=6144);
    hindsight_ext_ext       : i32 = 967    (512..=2048);
    corr_bonus_scale        : i32 = 130     (64..=256);
    corr_bonus_div          : i32 = 1050    (512..=2048);
    corr_pawn_factor        : i32 = 66      (32..=128);
    corr_minor_factor       : i32 = 61      (32..=128);
    corr_major_factor       : i32 = 66      (32..=128);
    corr_white_factor       : i32 = 62      (32..=128);
    corr_black_factor       : i32 = 60      (32..=128);
    corr_cont1_factor       : i32 = 67      (32..=128);
    corr_cont2_factor       : i32 = 68      (32..=128);
    main_bonus_base         : i32 = 124     (64..=256);
    main_bonus_scale        : i32 = 129     (64..=256);
    main_bonus_max          : i32 = 1946    (1024..=4096);
    main_malus_base         : i32 = 124     (64..=256);
    main_malus_scale        : i32 = 148     (64..=256);
    main_malus_max          : i32 = 1939    (1024..=4096);
    tactic_bonus_base       : i32 = 131     (64..=256);
    tactic_bonus_scale      : i32 = 125     (64..=256);
    tactic_bonus_max        : i32 = 2166    (1024..=4096);
    tactic_malus_base       : i32 = 124     (64..=256);
    tactic_malus_scale      : i32 = 118     (64..=256);
    tactic_malus_max        : i32 = 2001    (1024..=4096);
    cont1_bonus_base        : i32 = 128     (64..=256);
    cont1_bonus_scale       : i32 = 134     (64..=256);
    cont1_bonus_max         : i32 = 2030    (1024..=4096);
    cont1_malus_base        : i32 = 123     (64..=256);
    cont1_malus_scale       : i32 = 119     (64..=256);
    cont1_malus_max         : i32 = 1955    (1024..=4096);
    cont2_bonus_base        : i32 = 128     (64..=256);
    cont2_bonus_scale       : i32 = 117     (64..=256);
    cont2_bonus_max         : i32 = 2184    (1024..=4096);
    cont2_malus_base        : i32 = 128     (64..=256);
    cont2_malus_scale       : i32 = 124     (64..=256);
    cont2_malus_max         : i32 = 1937    (1024..=4096);
    cont4_bonus_base        : i32 = 129     (64..=256);
    cont4_bonus_scale       : i32 = 109     (64..=256);
    cont4_bonus_max         : i32 = 2146    (1024..=4096);
    cont4_malus_base        : i32 = 126     (64..=256);
    cont4_malus_scale       : i32 = 125     (64..=256);
    cont4_malus_max         : i32 = 1936    (1024..=4096);
    asp_initial_window      : i16 = 33      (10..=100);
    asp_widen_factor        : i32 = 116     (64..=256);
    hard_time_factor        : u128= 2134   (1024..=3072);
    soft_time_factor        : u128= 60     (32..=256);
    node_tm_base            : u32 = 2624    (1280..=3840);
    node_tm_scale           : u32 = 1482    (768..=3072);
    move_stability_base     : u32 = 1867    (920..=2760);
    move_stability_scale    : u32 = 101     (50..=200);
    move_stability_min      : u32 = 922     (768..=1024);
    pawn_see_val            : i32 = 92     (50..=200);
    knight_see_val          : i32 = 341     (150..=600);
    bishop_see_val          : i32 = 329     (150..=600);
    rook_see_val            : i32 = 482     (250..=1000);
    queen_see_val           : i32 = 819     (450..=1800);
    mat_scaling_base        : i32 = 27143   (12000..=50000);
    pawn_mat_scale          : i32 = 110     (50..=200);
    knight_mat_scale        : i32 = 294     (150..=600);
    bishop_mat_scale        : i32 = 268     (150..=600);
    rook_mat_scale          : i32 = 488     (250..=1000);
    queen_mat_scale         : i32 = 869     (450..=1800);
);
