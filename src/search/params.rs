...
tunable_params!(
    rfp_depth               : i32 = 5873    (4096..=12288);
    rfp_margin              : i16 = 52      (25..=100);
    rfp_quad_margin         : i16 = 812     (384..=1536);
    nmp_depth               : i32 = 2463    (0..=8192);
    nmp_red_base            : i32 = 7070    (3072..=12288);
    nmp_red_scale_div       : i32 = 595     (256..=1280);
    nmp_verif_min_depth     : i32 = 14783   (7168..=21504);
    movepick_see_threshold  : i16 = -26     (-100..=100);
    qs_see_threshold        : i16 = -30     (-100..=100);
    tactic_see_base         : i16 = 3       (0..=30);
    tactic_see_scale        : i32 = -60     (-120..=-30);
    quiet_see_base          : i16 = 1       (0..=30);
    quiet_see_scale         : i32 = -86     (-200..=-50);
    see_max_depth           : i32 = 11018   (5120..=15360);
    lmp_base                : u32 = 3651    (2048..=8192);
    lmp_scale               : u32 = 1182    (512..=2048);
    fp_depth                : i32 = 7522    (4096..=16384);
    fp_base                 : i16 = 112     (50..=200);
    fp_scale                : i32 = 71      (40..=160);
    hist_prune_scale        : i32 = 1906    (1000..=4000);
    hist_prune_depth        : i32 = 4289    (2048..=10240);
    se_min_depth            : i32 = 8622    (6144..=10240);
    se_tt_depth_offset      : i32 = 3897    (1024..=6144);
    se_beta_scale           : i32 = 282     (192..=384);
    se_depth_offset         : i32 = 1127    (0..=3072);
    se_depth_scale          : i32 = 65      (32..=128);
    se_dext_margin          : i16 = 19      (10..=40);
    se_single_ext           : i32 = 1191    (512..=2048);
    se_double_ext           : i32 = 975     (512..=2048);
    se_triple_negext        : i32 = -2546   (-4096..=-1536);
    se_double_negext        : i32 = -2187   (-3072..=-1024);
    se_single_negext        : i32 = -869    (-1536..=-512);
    quiet_hist_lmr_div      : i16 = 9468    (4096..=16384);

    lmr_min_depth           : i32 = 1483    (1024..=6144);
    lmr_base                : i32 = 523     (256..=1024);
    lmr_quiet_div           : i32 = 1775    (768..=3072);
    lmr_tactic_div          : i32 = 3388    (1792..=7168);
    lmr_nonpv               : i32 = 907     (512..=2048);
    lmr_ttpv                : i32 = 827     (512..=2048);
    lmr_check               : i32 = 784     (512..=2048);
    lmr_cutnode             : i32 = 1079    (512..=2048);

    corr_bonus_scale        : i32 = 115     (64..=256);
    corr_bonus_div          : i32 = 1145    (512..=2048);
    corr_pawn_factor        : i32 = 72      (32..=128);
    corr_minor_factor       : i32 = 77      (32..=128);
    corr_major_factor       : i32 = 78      (32..=128);
    corr_white_factor       : i32 = 67      (32..=128);
    corr_black_factor       : i32 = 67      (32..=128);
    corr_cont1_factor       : i32 = 70      (32..=128);
    corr_cont2_factor       : i32 = 65      (32..=128);

    main_bonus_base         : i32 = 135     (64..=256);
    main_bonus_scale        : i32 = 114     (64..=256);
    main_bonus_max          : i32 = 1552    (1024..=4096);
    main_malus_base         : i32 = 145     (64..=256);
    main_malus_scale        : i32 = 151     (64..=256);
    main_malus_max          : i32 = 2227    (1024..=4096);

    tactic_bonus_base       : i32 = 118     (64..=256);
    tactic_bonus_scale      : i32 = 142     (64..=256);
    tactic_bonus_max        : i32 = 2164    (1024..=4096);
    tactic_malus_base       : i32 = 106     (64..=256);
    tactic_malus_scale      : i32 = 130     (64..=256);
    tactic_malus_max        : i32 = 2110    (1024..=4096);

    cont1_bonus_base        : i32 = 146     (64..=256);
    cont1_bonus_scale       : i32 = 139     (64..=256);
    cont1_bonus_max         : i32 = 1704    (1024..=4096);
    cont1_malus_base        : i32 = 156     (64..=256);
    cont1_malus_scale       : i32 = 116     (64..=256);
    cont1_malus_max         : i32 = 2199    (1024..=4096);

    cont2_bonus_base        : i32 = 137     (64..=256);
    cont2_bonus_scale       : i32 = 131     (64..=256);
    cont2_bonus_max         : i32 = 1931    (1024..=4096);
    cont2_malus_base        : i32 = 112     (64..=256);
    cont2_malus_scale       : i32 = 142     (64..=256);
    cont2_malus_max         : i32 = 1977    (1024..=4096);

    asp_initial_window      : i16 = 38      (10..=100);
    asp_widen_factor        : i32 = 127     (64..=256);

    hard_time_factor        : u128 =1789    (1024..=3072);
    soft_time_factor        : u128 =90      (32..=256);

    node_tm_base            : u32 = 2211    (1280..=3840);
    node_tm_scale           : u32 = 1572    (768..=3072);

    move_stability_base     : u32 = 1924    (920..=2760);
    move_stability_scale    : u32 = 97      (50..=200);
    move_stability_min      : u32 = 919     (768..=1024);

    pawn_see_val            : i16 = 99      (50..=200);
    knight_see_val          : i16 = 288     (150..=600);
    bishop_see_val          : i16 = 317     (150..=600);
    rook_see_val            : i16 = 401     (250..=1000);
    queen_see_val           : i16 = 804     (450..=1800);
);
